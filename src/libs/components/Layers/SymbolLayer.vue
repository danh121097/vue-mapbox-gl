...
import { useCreateSymbolLayer, useLayerEventListener } from '@libs/hooks'
import type {
  Map,
  FilterSpecification,
  MapLayerEventType,
...
import type { CreateLayerActions, AnyLayout, SymbolLayerStyle } from '@libs/types'
...
interface Emits {
  ...
  (e: 'register', actions: CreateLayerActions<SymbolLayerSpecification>, map: Map): any
...
const props = withDefaults(
  defineProps<
    LayerProps & {
      register?: (actions: CreateLayerActions<SymbolLayerSpecification>, map: Map) => any
    }
  >(),
  {
    visible: undefined
