...
import { useCreateCircleLayer, useLayerEventListener } from '@libs/hooks'
import type {
  Map,
  FilterSpecification,
  MapLayerEventType,
...
import type { CreateLayerActions, AnyLayout, CircleLayerStyle } from '@libs/types'
...
interface Emits {
  ...
  (e: 'register', actions: CreateLayerActions<CircleLayerSpecification>, map: Map): any
...
const props = withDefaults(
  defineProps<
    LayerProps & {
      register?: (actions: CreateLayerActions<CircleLayerSpecification>, map: Map) => any
    }
  >(),
  {
    visible: undefined
