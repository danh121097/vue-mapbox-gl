...
import { useCreateHeatmapLayer, useLayerEventListener } from '@libs/hooks'
import type {
  Map,
  MapLayerEventType,
  MapLayerMouseEvent,
...
import type { CreateLayerActions, AnyLayout, HeatmapLayerStyle } from '@libs/types'
...
interface Emits {
  ...
  (e: 'register', actions: CreateLayerActions<HeatmapLayerSpecification>, map: Map): any
...
const props = withDefaults(
  defineProps<
    LayerProps & {
      register?: (actions: CreateLayerActions<HeatmapLayerSpecification>, map: Map) => any
    }
  >(),
  {
    visible: undefined
