...
import { useCreateRasterLayer, useLayerEventListener } from '@libs/hooks'
import type {
  Map,
  FilterSpecification,
  MapLayerEventType,
...
import type { CreateLayerActions, AnyLayout, RasterLayerStyle } from '@libs/types'
...
interface Emits {
  ...
  (e: 'register', actions: CreateLayerActions<RasterLayerSpecification>, map: Map): any
...
const props = withDefaults(
  defineProps<
    LayerProps & {
      register?: (actions: CreateLayerActions<RasterLayerSpecification>, map: Map) => any
    }
  >(),
  {
    visible: undefined
