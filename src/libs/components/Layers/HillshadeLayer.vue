...
import { useCreateHillshadeLayer, useLayerEventListener } from '@libs/hooks'
import type {
  Map,
  FilterSpecification,
  MapLayerEventType,
...
import type { CreateLayerActions, AnyLayout, HillshadeLayerStyle } from '@libs/types'
...
interface Emits {
  ...
  (e: 'register', actions: CreateLayerActions<HillshadeLayerSpecification>, map: Map): any
...
const props = withDefaults(
  defineProps<
    LayerProps & {
      register?: (actions: CreateLayerActions<HillshadeLayerSpecification>, map: Map) => any
    }
  >(),
  {
    visible: undefined
