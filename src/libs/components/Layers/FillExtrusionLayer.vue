...
import { useCreateFillExtrusionLayer, useLayerEventListener } from '@libs/hooks'
import type {
  Map,
  FilterSpecification,
  MapLayerEventType,
...
import type { CreateLayerActions, AnyLayout, FillExtrusionLayerStyle } from '@libs/types'
...
interface Emits {
  ...
  (e: 'register', actions: CreateLayerActions<FillExtrusionLayerSpecification>, map: Map): any
...
const props = withDefaults(
  defineProps<
    LayerProps & {
      register?: (actions: CreateLayerActions<FillExtrusionLayerSpecification>, map: Map) => any
    }
  >(),
  {
    visible: undefined
