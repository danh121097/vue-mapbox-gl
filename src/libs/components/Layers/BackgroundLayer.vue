...
import { useCreateBackgroundLayer, useLayerEventListener } from '@libs/hooks'
import type {
  Map,
  MapLayerEventType,
  MapLayerMouseEvent,
...
import type { CreateLayerActions, BackgroundLayerStyle, AnyLayout } from '@libs/types'
...
interface Emits {
  ...
  (e: 'register', actions: CreateLayerActions<BackgroundLayerSpecification>, map: Map): any
...
const props = withDefaults(
  defineProps<
    LayerProps & {
      register?: (actions: CreateLayerActions<BackgroundLayerSpecification>, map: Map) => any
    }
  >(),
  {
    visible: undefined
